...
export default function TeamPage() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 flex flex-col p-20">
      <div className="max-w-7xl mx-auto px-4 mt-10">
        <div className="flex flex-col lg:flex-row gap-30">
          ...
          >
            <motion.div className="rounded-xl p-6 shadow-lg border border-[#1DF53A] bg-[#130F3F]/60">
                        ...
                        <TableCell>
                          <AlertDialog>
                            <AlertDialogTrigger asChild>
                              <Button className="bg-[#1DF53A] text-black hover:bg-[#17c72f]">
                                Join
                              </Button>
                            </AlertDialogTrigger>
                ...
                <>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input
                        className="bg-[#0D0D0E] border-[#1DF53A] text-[#EAEAEA] placeholder:text-neutral-500 mb-4"
                    ...
                    <Button
                      className="mx-auto block px-4 py-2 rounded bg-[#1DF53A] text-black hover:bg-[#17c72f] mb-1"
